...
export declare class Ng2Carouselamos {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<Ng2Carouselamos, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<Ng2Carouselamos, "[ng2-carouselamos]", never, { "items": "items"; "width": "width"; "$prev": "$prev"; "$next": "$next"; "$item": "$item"; }, { "onSelectedItem": "onSelectedItem"; }, never, never>;
}

//# sourceMappingURL=ng2-carouselamos.component.d.ts.map